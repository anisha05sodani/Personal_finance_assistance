...
from ..schemas.transaction import TransactionCreate, TransactionRead, PaginatedTransactionResponse
...
def list_transactions(
    ...
    return TransactionService.get_transactions(
        db, user, skip, limit, start_date, end_date, category, type, search
    )
