...
export default function Register() {
  ...
  return (
    <div className="flex items-center min-h-[100vh] bg-gray-50 dark:bg-black transition-colors duration-300">
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 w-full max-w-lg flex justify-center m-4">
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition dark:bg-blue-700 dark:hover:bg-blue-800 mb-4"
          >
            Register
          </button>
